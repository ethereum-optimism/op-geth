...
type PayloadAttributes struct {
	...
	// MinBaseFeeFactors is a field for rollups implementing the minimum base fee feature,
	// and contains the significand and exponent (base 10) of the minimum base fee.
	MinBaseFeeFactors uint8 `json:"minBaseFeeFactors,omitempty" gencodec:"optional"`
}
