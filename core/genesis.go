...
func hashAlloc(ga *types.GenesisAlloc, isUBT, isIsthmus bool) (common.Hash, common.Hash, error) {
...
func (g *Genesis) ToBlock() *types.Block {
	...
	} else if stateRoot, storageRootMessagePasser, err = hashAlloc(&g.Alloc, g.IsUBT(), g.Config.IsOptimismIsthmus(g.Timestamp)); err != nil {
		panic(err)
	}
