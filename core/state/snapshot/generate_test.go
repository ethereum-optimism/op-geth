...
func testGenerateExistentStateWithWrongAccounts(t *testing.T, scheme string) {
	...
	// Wrong accounts
	{
		...
		helper.addSnapAccount("acc-2", &types.StateAccount{Balance: big.NewInt(1), Root: stRoot, CodeHash: common.Hex2Bytes("1234")})
	...
	// Extra accounts, only in the snap
	{
		...
		helper.addSnapAccount("acc-5", &types.StateAccount{Balance: big.NewInt(1), Root: types.EmptyRootHash, CodeHash: common.Hex2Bytes("1234")})  // Middle
