...
type PrecompiledContract interface {
	RequiredGas(input []byte, evm *EVM, caller ContractRef) uint64  // RequiredPrice calculates the contract gas use
	Run(input []byte, evm *EVM, caller ContractRef) ([]byte, error) // Run runs the precompiled contract
}
...
var PrecompiledContractsGranite = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0x0a}):       &kzgPointEvaluation{},
	common.BytesToAddress([]byte{0x01, 0x00}): &p256Verify{},
	common.BytesToAddress([]byte{0x01, 0x01}): &gasback{},
}
...
func RunPrecompiledContract(p PrecompiledContract, input []byte, suppliedGas uint64, evm *EVM, caller ContractRef) (ret []byte, remainingGas uint64, err error) {
	gasCost := p.RequiredGas(input, evm, caller)
...
func (c *ecrecover) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.EcrecoverGas
}

func (c *ecrecover) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
func (c *sha256hash) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return uint64(len(input)+31)/32*params.Sha256PerWordGas + params.Sha256BaseGas
}
func (c *sha256hash) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// This method does not require any overflow checking as the input size gas costs
// required for anything significant is so high it's impossible to pay for.
func (c *ripemd160hash) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return uint64(len(input)+31)/32*params.Ripemd160PerWordGas + params.Ripemd160BaseGas
}
func (c *ripemd160hash) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// This method does not require any overflow checking as the input size gas costs
// required for anything significant is so high it's impossible to pay for.
func (c *dataCopy) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return uint64(len(input)+31)/32*params.IdentityPerWordGas + params.IdentityBaseGas
}
func (c *dataCopy) Run(in []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bigModExp) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	var (
...
func (c *bigModExp) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
	var (
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bn256AddIstanbul) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bn256AddGasIstanbul
}

func (c *bn256AddIstanbul) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bn256AddByzantium) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bn256AddGasByzantium
}

func (c *bn256AddByzantium) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
	return runBn256Add(input)
}
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bn256ScalarMulIstanbul) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bn256ScalarMulGasIstanbul
}

func (c *bn256ScalarMulIstanbul) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bn256ScalarMulByzantium) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bn256ScalarMulGasByzantium
}

func (c *bn256ScalarMulByzantium) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
	return runBn256ScalarMul(input)
}
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bn256PairingGranite) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return new(bn256PairingIstanbul).RequiredGas(input, nil, nil)
}

func (c *bn256PairingGranite) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bn256PairingIstanbul) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bn256PairingBaseGasIstanbul + uint64(len(input)/192)*params.Bn256PairingPerPointGasIstanbul
}

func (c *bn256PairingIstanbul) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
	return runBn256Pairing(input)
}
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bn256PairingByzantium) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bn256PairingBaseGasByzantium + uint64(len(input)/192)*params.Bn256PairingPerPointGasByzantium
}

func (c *bn256PairingByzantium) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
	return runBn256Pairing(input)
}

type blake2F struct{}

func (c *blake2F) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
...
func (c *blake2F) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381G1Add) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bls12381G1AddGas
}

func (c *bls12381G1Add) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381G1Mul) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bls12381G1MulGas
}

func (c *bls12381G1Mul) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381G1MultiExp) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
...
func (c *bls12381G1MultiExp) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381G2Add) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bls12381G2AddGas
}

func (c *bls12381G2Add) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381G2Mul) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bls12381G2MulGas
}

func (c *bls12381G2Mul) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381G2MultiExp) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
...
func (c *bls12381G2MultiExp) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381Pairing) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bls12381PairingBaseGas + uint64(len(input)/384)*params.Bls12381PairingPerPairGas
}

func (c *bls12381Pairing) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381MapG1) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bls12381MapG1Gas
}

func (c *bls12381MapG1) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
// RequiredGas returns the gas required to execute the pre-compiled contract.
func (c *bls12381MapG2) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.Bls12381MapG2Gas
}

func (c *bls12381MapG2) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
func (b *kzgPointEvaluation) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
...
func (b *kzgPointEvaluation) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
...
func (c *p256Verify) RequiredGas(input []byte, _ *EVM, _ ContractRef) uint64 {
	return params.P256VerifyGas
}

// Run executes the precompiled contract with given 160 bytes of param, returning the output and the used gas
func (c *p256Verify) Run(input []byte, _ *EVM, _ ContractRef) ([]byte, error) {
