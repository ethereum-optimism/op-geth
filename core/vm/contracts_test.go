...
var allPrecompiles = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0xfc}): &bls12381G1MultiExpIsthmus{},
	common.BytesToAddress([]byte{0x0d}): &bls12381G2Add{},
	common.BytesToAddress([]byte{0x0e}): &bls12381G2MultiExpPrague{},
	common.BytesToAddress([]byte{0xfe}): &bls12381G2MultiExpIsthmus{},
	common.BytesToAddress([]byte{0x0f}): &bls12381PairingPrague{},
	common.BytesToAddress([]byte{0xff}): &bls12381PairingIsthmus{},
...
func TestPrecompileBlsInputSize(t *testing.T) {
	...
	testPrecompiledFailure("fc", precompiledFailureTest{
		Input:         common.Bytes2Hex(big),
	...
	testPrecompiledFailure("fe", precompiledFailureTest{
		Input:         common.Bytes2Hex(big),
	...
	testPrecompiledFailure("ff", precompiledFailureTest{
		Input:         common.Bytes2Hex(big),
